...
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{pdf/u1rnp.pdf}
{\cleardoublepage}
...
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{pdf/mtx_vs_aza.pdf}
{\cleardoublepage}
...
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{pdf/ro52.pdf}
{\cleardoublepage}
...
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{pdf/mi2_clinical.pdf}
{\cleardoublepage}
...
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{pdf/mi2_serologic.pdf}
{\cleardoublepage}
...
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{pdf/atb_class.pdf}
{\cleardoublepage}
...
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{pdf/autoantigens.pdf}
{\cleardoublepage}
...
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{pdf/ifn.pdf}
{\cleardoublepage}

\section{Machine learning algorithms reveal unique gene expression profiles in muscle biopsies from patients with different types of myositis. Ann Rheum Dis 2020 (PMID: 32546599).}
\label{sec:rnaseq_ml}
...
\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{pdf/rnaseq_ml.pdf}